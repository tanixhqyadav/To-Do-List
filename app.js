...
const todob=document.querySelector("#to-do-list");
...
const addToDo = (item) =>{
    ...
    listItem.querySelector("#crox").addEventListener(
        "click",
        function(){
            listItem.remove()
        }
    )
    todob.appendChild(listItem);
}